package com.example.Proyecto.First.Commit.security.config;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    CorsConfigurationSource corsConfigurationSource()
    {
        ...
        configuration.setAllowedOriginPatterns(List.of("http://localhost:4200", "https://angular-springboot1-beta.vercel.app", "http://localhost:3000"));
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                ...
                .authorizeRequests().antMatchers("/api/user/**","/api/auth/**").permitAll()
